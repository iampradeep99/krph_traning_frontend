...
const CreateNewTraining = () => {
  ...
  return (<>
    ...
    <CommonHeader
                title="Create Training Calendar"
                subtitle=""
      ...
      <form>
        <div className="form-row">
          <div className="form-group">
            ...
            <input type="text" id="agent-name" placeholder="Enter Full Name" required />
          </div>
          <div className="form-group">
            <label htmlFor="agent-email">Agent email ID *</label>
            <input type="email" id="agent-email" placeholder="Enter agent email ID" required />
          </div>
        </div>
        ...
        <div className="form-row">
          <div className="form-group">
            ...
            <input type="date" id="training-date" placeholder="22/11/2024" required />
          </div>
          <div className="form-group time-group" style={{ display: "flex", flexDirection: "row", gap: "20px" }}>
          <div>
              <label htmlFor="training-start-time">Training start time *</label>
              <input style={{ width: "200px" }} type="time" id="training-start-time" required />

            </div>
            <div>
              <label htmlFor="training-end-time">Training end time *</label>
              <input style={{ width: "200px" }} type="time" id="training-end-time" required />
            </div>
          </div>
        </div>
        ...
        <div className="form-row">
          ...
          <div className="form-group">
            ...
            <input type="url" id="training-link" placeholder="https://meet.google.com/..." required />
          </div>
        </div>
