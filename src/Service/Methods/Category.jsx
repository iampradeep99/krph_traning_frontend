...
export const addCategoryMasterData = async (formData) => {
  try {
    ...
    const result = await ApiCalling(requestData, APIEndpoints.Category.AddCategoryMaster);
    return result;
  } catch (error) {
    console.log(error);
    return {
...
export const updateCategoryMasterData = async (formData) => {
    try {
      ...
      const result = await ApiCalling(requestData, APIEndpoints.Category.UpdateCategoryMaster);
      return result;
    } catch (error) {
      console.log(error);
      return {
