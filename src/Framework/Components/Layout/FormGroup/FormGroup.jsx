...
import {
  ReactSelectStyle,
  ReactMultiSelectStyle,
} from "Framework/Assets/Styles/Widgets/SelectStyle/SelectStyle";
import {
  FormStyle,
  FormGroupStyle,
  InputGroupStyle,
  ...
  return (
    <div
      className={classNames(
        BizClass.InputGroupBox,
        errorMsg ? BizClass.InputErrorMsgBox : null,
        row ? BizClass.ControlRowSpan : null,
      )}
    >
      {label ? (
        <InputLabelStyle
          className={classNames(
            BizClass.InputLabel,
            req === "true" ? BizClass.InputReqLabel : null,
          )}
      ...
      >
        {children}
        {errorMsg ? (
          <span className={BizClass.ErrorMsg}>{errorMsg}</span>
        ) : null}
      </InputGroupStyle>
    </div>
  );
    ...
    case "switch":
      InputControl = (
        <label className={BizClass.Switch}>
          <input
            className={classNames(BizClass.Switch_input, className)}
            type="checkbox"
            ref={focus === "true" ? firstFormInput : ref}
            {...restProps}
          />
