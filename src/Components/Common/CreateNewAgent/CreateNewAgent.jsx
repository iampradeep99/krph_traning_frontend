...
const CreateNewAgent = () => {
    ...
    return (
        ...
        <CommonHeader
                ...
                buttons={[
                    { label: "Upload Excel Sheet", onClick: handleUploadClick, type: "upload" },
                    { label: "Download Sample", onClick: handleDownloadClick, type: "download" },
                ]}
            />
                ...
                <form className="agent-form" onSubmit={handleSubmit}>
                    ...
                    <div className="form-group">
                        ...
                        <div className="form-group">
                            ...
                            <input type="date" id="training-date" name="DOB" placeholder="22/11/2024" required   value={formData.mobile}
                                onChange={handleChange}/>
